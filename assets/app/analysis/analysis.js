...
{ 
    ...
    analysis.config(function($stateProvider, $urlRouterProvider) {
        ...
        .state('analysis.models', {
            ...
            templateUrl: '/analysis/models/list.html'
        })
        .state('analysis.modeldetails', {
            url: '/model/:modelId',
            controller: 'ModelDetailsCtrl',
            templateUrl: '/analysis/models/modelinfo.html'
        })
        .state('analysis.classification', {
            url: '/classification',
            controller: 'ClassificationCtrl',
            templateUrl: '/analysis/classification/list.html'
        })
        .state('analysis.soundscapes', {
            url: '/soundscapes',
            controller: 'SoundscapesCtrl as controller',
            templateUrl: '/analysis/soundscapes/list.html'
        });
    });
}
)(angular);
