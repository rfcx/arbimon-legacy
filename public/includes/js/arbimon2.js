...
}]).controller('PatternMatchingCtrl', ["$scope", "$modal", "JobsData", "$location", "notify", "$q", "a2PatternMatching", "a2UserPermit", "$state", "$stateParams", "Project", function ($scope, $modal, JobsData, $location, notify, $q, a2PatternMatching, a2UserPermit, $state, $stateParams, Project) {
...
}]).controller('SoundscapesCtrl', ["$window", "$scope", "$modal", "$filter", "Project", "JobsData", "ngTableParams", "a2Playlists", "$location", "a2Soundscapes", "notify", "a2UserPermit", function ($window, $scope, $modal, $filter, Project, JobsData, ngTableParams, a2Playlists, $location, a2Soundscapes, notify, a2UserPermit) {
  var $ = $window.$;
  $scope.successInfo = "";
  $scope.showSuccess = false;
  $scope.errorInfo = "";
...
}]).controller('ModelsCtrl', ["$scope", "$modal", "$filter", "ngTableParams", "Project", "a2Models", "JobsData", "$location", "notify", "a2UserPermit", function ($scope, $modal, $filter, ngTableParams, Project, a2Models, JobsData, $location, notify, a2UserPermit) {
  $scope.infoInfo = "Loading...";
  $scope.showInfo = true;
  $scope.loading = true;
