...
async function sendEmail (subject, title, rowData, content, isSignedUrl) {
    ...
    if (isSignedUrl) {
        if (isGmail) {
            ...
            + `<img style="width: 14px; height: 14px; margin-left:8px" src="https://static.rfcx.org/arbimon/download-icon.png"><span style="color:#000"> Download </span><a href="${content}"> here </a>`
            + textFooter;
    } else {
        message.attachments = [{
            type: 'text/csv',
