...
INSERT INTO `arbimon2`.`roles` (`name`, `description`, `level`) VALUES ('Citizen Scientist', 'Citizen Scientist - User can only see the Citizen Scientist interface and add validations to the pattern matchings', '6');
